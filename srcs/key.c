...
/*   Updated: 2021/11/18 11:05:08 by vneirinc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_pressnew(int keycode, t_game *game)
{
	...
	if (keycode == KEY_A)
	{
		if (map[(int)game->p->pos.y][(int)(game->p->pos.x + (game->p->dir.x * cos(1.5708) - game->p->dir.y * sin(1.5708)) * 0.2 - game->p->dir.x * 0.2)] != '1')
